...
export default function TransactionsPage() {
  ...
  const canEditReceipt = useCan("UPDATE", "RECEIPT", selectedBuId ?? null);
  const canEditPayment = useCan("UPDATE", "PAYMENT", selectedBuId ?? null);
  const canDeleteReceipt = useCan("DELETE", "RECEIPT", selectedBuId ?? null);
  const canDeletePayment = useCan("DELETE", "PAYMENT", selectedBuId ?? null);
  const canCreateReceipt = useCan("CREATE", "RECEIPT", selectedBuId ?? null);
  const canCreatePayment = useCan("CREATE", "PAYMENT", selectedBuId ?? null);
